/*
===============================================================================
Stored Function: Load Silver Layer (Bronze -> Silver)
===============================================================================
Script Purpose:
    This stored function performs the ETL (Extract, Transform, Load) process to 
...
CREATE OR REPLACE FUNCTION silver.load_bronze()
RETURNS void
LANGUAGE plpgsql
AS $$
DECLARE
...
ELSE 'n/a'
END cst_marital_status, --normalize marital status values to feadable format
...
RAISE NOTICE '   - Total Load Duration: % seconds', ROUND(v_batch_duration, 2);
RAISE NOTICE '==========================================';
